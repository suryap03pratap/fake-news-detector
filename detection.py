...
if input_text:
    ...
    if pred == 1:
        st.write(" Make sure you don't go with the news \n The News is Fake")
    else:
        st.write('You can go with the news \n The News Is Real')
...
print(news_df['content'][20])  # this must be fake
print(news_df['content'][10])  # this must be real
